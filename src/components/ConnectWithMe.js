...
const ConnectWithMe = () => {
  return (
    <div className="mt-12 bg-gray-100 dark:bg-dark-800 rounded-lg shadow-lg p-6 hover:scale-105 duration-300 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <a
          ...
          className="flex flex-col items-center justify-center p-4 bg-gray-200 dark:bg-dark-700 rounded-lg hover:bg-gray-300 dark:hover:bg-dark-600 transition-colors duration-300"
        >
          <FontAwesomeIcon icon={faGithub} className="text-3xl text-gray-900 dark:text-white mb-2 transition-colors duration-300" />
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white transition-colors duration-300">GitHub</h3>
